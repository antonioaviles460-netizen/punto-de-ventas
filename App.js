...
const firebaseConfig = {
  apiKey: "AIzaSyARCwq8jqXrXSF_CliJsYxzTwHfWBk13ng",
  authDomain: "ar-market-f7208.firebaseapp.com",
  projectId: "ar-market-f7208",
  storageBucket: "ar-market-f7208.firebasestorage.app",
  messagingSenderId: "840632491344",
  appId: "1:840632491344:web:4b19c57ff0d68d967ce055"
};
...
const App = () => {
  ...
  const registrarTransaccion = async (prod, esCredito = false) => {
    ...
    if (esCredito) {
      // Si hay un cliente seleccionado (para crédito), podríamos pedir datos
      // Por ahora, preguntamos nombre y teléfono
      clienteNombre = prompt("Nombre del cliente:").toUpperCase().trim();
      if (!clienteNombre) return;
      clienteTelefono = prompt("Teléfono del cliente (opcional):").trim();
      
      // Calcular deuda actual del cliente (suma de saldos de cuentas no pagadas)
    ...
    try {
      if (esCredito) {
        // Crear cuenta por cobrar con campos de abono
  ...
  const realizarAbono = async () => {
    ...
    try {
      ...
      // Opcional: registrar el abono en una colección 'abonos'
      ...
      // Si estamos viendo detalle de cliente, actualizamos la lista
      ...
      <main className="content">
        ...
        {view === 'cobrar' && (
          <div className="cobrar-view fade-in">
            ...
            {/* Botón para agregar cliente manualmente (opcional) */}
            <button 
          ...
          <div className="modal-content">
            ...
            <div className="modal-actions">
              <button className="confirm-btn" onClick={() => {
                // Aquí podrías guardar el cliente en una colección "clientes" si lo deseas
